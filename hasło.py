...
password_length = int(input('Podaj mi jak długie ma być hasło?'))

if password_length < 5:
    print('Hasło musi mieć ponad 5 znaków, spróbuj jeszcze raz.')
    sys.exit(0)
else:
...
print('wygeneowane hasło:', ''.join(password))
